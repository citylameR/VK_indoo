...
profile_keys.add_button("Имя", color=VkKeyboardColor.SECONDARY)
profile_keys.add_button("Город", color=VkKeyboardColor.SECONDARY)
profile_keys.add_line()
profile_keys.add_button("Возраст", color=VkKeyboardColor.SECONDARY)
profile_keys.add_button("Диапазон", color=VkKeyboardColor.SECONDARY)
profile_keys.add_line()
